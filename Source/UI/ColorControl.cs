...
namespace Celeste.Mod.Hyperline.UI
{
    ...
    public class ColorControl : HMenuItem, IDisposable
    {
        ...
        private const float ValueSatScrollSpeedFast = 0.1f;
        ...
        public ColorControl(string label, float h, float s, float v)
        {
            ...
            hueButton = new("Hue");
            valueButton = new("Value/Saturation");
        ...
        public ColorControl Change(Action<float, float, float> newOnValueChange)
        {
        ...
        public override void Render(Vector2 position, bool highlighted)
        {
            ...
            if (Focused)
            {
                ...
                Vector2 huePosition = hueTextPositionCenter + new Vector2(-gradientTexture.Width / 2f, ActiveFont.LineHeight * 1.25f);
                Vector2 valuePosition = valueTextPositionCenter + new Vector2(-renderTarget.Width / 2f, ActiveFont.LineHeight * 1.25f);
                ...
                Vector2 hueSelectorPosition = huePosition + new Vector2(gradientTexture.Width / 2f, h / 360f * gradientTexture.Height); // scale the height based on the current hue
        ...
        {
            Color[] data = [new(255, 255, 255, 255)];
        ...
        private static void CreateRenderTarget()
        {
            ...
            renderTarget = new(Engine.Graphics.GraphicsDevice, HSVBoxSize, HSVBoxSize);
            spriteBatch = new(Engine.Graphics.GraphicsDevice);
            hsvTexture = TextureDotCreate(Engine.Graphics.GraphicsDevice);
            ...
            else
            {
                try
                {
                    hsvEffect = new(Engine.Graphics.GraphicsDevice, shaderCode.Data);
                }
                catch (Exception ex)
                {
        ...
        public override void Update()
        {
            ...
            float valueSatSpeed = isFastHeld ? ValueSatScrollSpeedFast : ValueSatScrollSpeed;
